...
const Form = () => {
    ...
    const [CurrencyValue, setCurrencyValue] = useState({ worth: currencies[0].worth });

    const onFormSubmit = (event) => {
        event.preventDefault();
        calculateResult(amount, CurrencyValue, setCurrencyValue);
    };
    const calculateResult = (amount, CurrencyValue, setCurrencyValue) => {
        const calculationResult = (amount / CurrencyValue) * setCurrencyValue;
